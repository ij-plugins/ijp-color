...
import net.sf.ij_plugins.color.calibration.ui.CorrectionRecipe
import net.sf.ij_plugins.color.calibration.ui.tasks.Utils.applyCorrection
import net.sf.ij_plugins.color.calibration.{ColorCalibrator, Corrector, toPolygonROI}
