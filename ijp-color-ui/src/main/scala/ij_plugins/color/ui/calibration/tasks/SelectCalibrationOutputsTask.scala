...
class SelectCalibrationOutputsTask(src: OutputConfig) extends SimpleTask[Option[OutputConfig]] {
  ...
  override def call(): Option[OutputConfig] = {
    ...
    val gd =
      new GenericDialog("Select outputs that will be generated by calibration", IJ.getInstance()) {
        addMessage("Select outputs that will be generated by \"Calibrate\"")
        addMessage("Calibrated images:")
        ...
        addMessage("Diagnostic information:")
