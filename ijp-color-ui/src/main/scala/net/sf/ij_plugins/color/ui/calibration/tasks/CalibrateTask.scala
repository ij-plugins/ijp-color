...
package net.sf.ij_plugins.color.ui.calibration.tasks
...
import net.sf.ij_plugins.color.ui.fx.ColorFXUI
import net.sf.ij_plugins.color.ui.util.PlotUtils
import net.sf.ij_plugins.color.ui.util.PlotUtils.ValueEntry
import net.sf.ij_plugins.color.util.delta
