...
class MappingFactoryTest extends AnyFlatSpec {
  ...
  it should "createLinearNoInterceptXBand (for a band)" in {
    ...
    val observed = IndexedSeq(
      IndexedSeq(50.0181598062954, 20.692493946731236, 6.2941888619854724),
      IndexedSeq(123.94199243379572, 60.84741488020177, 43.90668348045397),
      IndexedSeq(52.774739583333336, 48.147135416666664, 55.24609375),
      IndexedSeq(49.07827260458839, 45.76923076923077, 3.4116059379217276),
      IndexedSeq(80.11018131101812, 56.83682008368201, 76.83124128312413),
      IndexedSeq(70.71551724137932, 104.76867816091954, 77.96120689655173),
      IndexedSeq(129.9434832756632, 48.10957324106113, 6.1280276816609),
      IndexedSeq(122.0730198019802, 31.084158415841586, 27.407178217821784),
      IndexedSeq(34.896153846153844, 13.28974358974359, 25.8),
      IndexedSeq(111.19521912350598, 106.04780876494024, 0.0),
      IndexedSeq(159.51440329218107, 89.1673525377229, 0.0),
      IndexedSeq(42.25541619156214, 64.54161915621437, 4.850627137970354),
      IndexedSeq(101.95985832349469, 20.65289256198347, 14.334120425029516),
      IndexedSeq(166.38536585365853, 109.20487804878049, 0.0),
      IndexedSeq(118.84702907711757, 41.25031605562579, 65.6826801517067),
      IndexedSeq(160.03979057591624, 124.83769633507853, 102.07748691099476),
      IndexedSeq(130.071661237785, 99.51031487513572, 81.14332247557003),
      IndexedSeq(101.88004484304933, 76.65807174887892, 62.26569506726457),
      IndexedSeq(71.38675958188153, 50.54239256678281, 37.92566782810685),
      IndexedSeq(42.70169082125604, 29.83816425120773, 21.544685990338163),
      IndexedSeq(15.848180677540778, 5.183186951066499, 2.986198243412798)
    )
